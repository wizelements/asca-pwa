  ...
  try {
    ...
    const events = [
      ...
      },
      {
        ...
        time: '2:00 PM',
        location: 'ASCA Facility, Atlanta, GA',
        image: '/images/events/lessons.jpg',
        rsvpLimit: 8,
        published: true,
        createdAt: new Date(),
      },
      ...
      },
      {
        ...
        image: '/images/events/campout.jpg',
        rsvpLimit: 30,
        published: true,
        createdAt: new Date(),
      },
    ...
    const members = [
      {
        ...
        image: '/images/members/clariece.jpg',
        createdAt: new Date(),
      },
      {
        name: 'Marcus Johnson',
        ...
        image: '/images/members/marcus.jpg',
        createdAt: new Date(),
      },
      {
        name: 'Sarah Williams',
      ...
      },
      {
        ...
        image: '/images/members/jessica.jpg',
        createdAt: new Date(),
      },
    ];
    ...
    const galleryImages = [
      {
        ...
        category: 'rides',
        url: '/images/gallery/trail-1.jpg',
